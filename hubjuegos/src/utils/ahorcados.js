import { wordList } from "../global/data/wordList";
import {
    getInfoAhorcado,
    setAciertos,
    setErrores,
...
export const iniciar = (event) => {
    ...
    const cant_wordList = wordList.length;
    const valor_al_azar = obtener_random(0, cant_wordList);
    setPalabrita(wordList[valor_al_azar]);
